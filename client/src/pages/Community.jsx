...
const Community = () => {
  ...
  return (
    <div className="p-6 pt-12 xl:px-12 2xl:px-20 w-full mx-auto h-full overflow-y-scroll">
      <h2 className="text-x1 font-semibold mb-6 text-gray-800 dark:text-purple-100">
        Community Images
      </h2>
        ...
        <div className="flex flex-wrap max-sm:justify-center gap-5">
          {images.map((item, index) => (
            <a
              ...
              href={item.imageUrl}
              target="_blank"
              className="relative group block rounded-1g overflow-hidden border border-gray-200 dark: border-purple-700 shadow-sm hover: shadow-md
